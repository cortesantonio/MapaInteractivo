...
import { faMagnifyingGlass, faFilter, faBuilding, faLocationDot, faChevronLeft, faChevronRight } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className={styles.filtros}>
                    <div style={{ display: 'flex', gap: '5px', flexWrap: 'wrap', justifyContent: 'center' }}>
                        ...
                        <div className={styles.add_user} >
                            <button style={{ gap: '10px', display: 'flex' }} onClick={() => { navigate('/panel-administrativo/marcadores/agregar') }}>
